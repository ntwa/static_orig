...
function appendTeamToGarden(box){
	...
	if(current_garden=="Nothing");
     ...
     selected_beneficiary_id=beneficiary_ids[posn];
             ...
             comment_url="http://ict4d01.cs.uct.ac.za/facebook/example/garden/";
             ...
             var fblike=teamlabel;
              ...
              fblike=fblike+"<iframe id='gardenfblikebt' src='//www.facebook.com/plugins/like.php?href=http://ict4d01.cs.uct.ac.za/facebook/example";
...
fblike=fblike+"/garden/";
            ...
            fblike_url="http://ict4d01.cs.uct.ac.za/facebook/example";
//fblike=fblike+selected_beneficiary_id;
...
jQuery.ajax({
          url: "http://ict4d01.cs.uct.ac.za/facebook/dataupdate/SN/",
      type: "POST",
          cache: false,
      contentType: "application/json",
      data: JSON.stringify(jsonObjects),
...
{             
            ...
            //  alert(limit);
             ...
             comment_url="http://ict4d01.cs.uct.ac.za/facebook/example/fishtank/";
             comment_url=comment_url+selected_beneficiary_id;
             ...
             var fblike=teamlabel;
              ...
              fblike=fblike+"<iframe id='likebt' src='//www.facebook.com/plugins/like.php?href=http://ict4d01.cs.uct.ac.za/facebook/example";
//fblike=fblike+selected_beneficiary_id;
...
var url="http://ict4d01.cs.uct.ac.za/facebook/example/#fishtank?q="
url=url+str_id;
...
jQuery.ajax({
          url: "http://ict4d01.cs.uct.ac.za/facebook/jsondata/SN/",
      type: "POST",
          cache: false,
      contentType: "application/json",
      data: JSON.stringify(jsonObjects),
